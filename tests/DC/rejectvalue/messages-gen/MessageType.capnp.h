...
struct MessageType {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(b350bf06f720699e, 1, 0)
    #if !CAPNP_LITE
...
inline float MessageType::Reader::getValue() const {
  return _reader.getDataField<float>(
      0 * ::capnp::ELEMENTS);
}

inline float MessageType::Builder::getValue() {
  return _builder.getDataField<float>(
      0 * ::capnp::ELEMENTS);
}
inline void MessageType::Builder::setValue(float value) {
